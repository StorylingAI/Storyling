...
export const users = mysqlTable("users", {
  ...
  subscriptionTier: mysqlEnum("subscription_tier", ["free", "premium"]).default("free").notNull(),
...
export const generatedContent = mysqlTable("generated_content", {
  ...
  thumbnailStyle: mysqlEnum("thumbnail_style", ["realistic", "illustrated", "minimalist"]).default("realistic"), // Thumbnail visual style
