...
interface VoicePreviewButtonEnhancedProps {
...
export function VoicePreviewButtonEnhanced({
  targetLanguage,
  voiceType,
  narratorGender,
  playingPreview,
  ...
  previewAudio,
  setPreviewAudio,
}: VoicePreviewButtonEnhancedProps) {
  ...
  return (
    <Button
      ...
      className="w-full rounded-xl border-2 border-primary/20 hover:border-primary/40 hover:bg-primary/5"
    >
      {isGenerating ? (
        <>
