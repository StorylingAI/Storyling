  ...
  const requestPermission = async () => {
    ...
    try {
      ...
      if (permission === "granted") {
        // Use existing SW registration (registered by vite-plugin-pwa in main.tsx)
        ...
        const sub = await registration.pushManager.subscribe({
          ...
          applicationServerKey: urlBase64ToUint8Array(
            ...
            "BIHswfRCMAiILySY9E9MlEgE_vAIjj53OppZLnCIpoTFU0C7fj7QddWJZVjJDo8Z2yHnVMNjqcJUUR344oRkfCw"
          )
        });
