...
export default function Referrals() {
  ...
  return (
    <>
      <MobileNav title="Referral Program" backPath="/app" />
      {referralCode && (
        <>
      ...
      <div className="flex justify-between items-start">
        ...
        <Button onClick={() => setLocation("/payout-management")} variant="outline" className="opacity-60 cursor-not-allowed relative">
