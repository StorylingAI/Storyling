      ...
      {!isPremium && usage && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Track your story creation this month</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="w-full bg-secondary rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${Math.min((usage.storiesThisMonth / (usage.storiesLimit || 1)) * 100, 100)}%`,
                  }}
                />
              </div>
              {!usage.canCreateStory && (
                <Alert className="mt-4">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    You've reached your monthly limit. Upgrade to Premium for unlimited stories.
                  </AlertDescription>
                </Alert>
              )}
            </div>
