      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50 shadow-playful">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold gradient-text-primary">Collections</h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
              ...
              <Button className="rounded-button gradient-primary text-white hover-lift border-0" data-tutorial="create-collection">
            ...
            <DialogContent className="rounded-card">
              ...
              <DialogFooter>
                <Button variant="outline" onClick={() => setIsCreateOpen(false)} className="rounded-button">
                  Cancel
                </Button>
                <Button
