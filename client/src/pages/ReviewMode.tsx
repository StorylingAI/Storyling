      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-teal-50 to-pink-50">
        <header className="bg-white/80 backdrop-blur-sm border-b shadow-playful sticky top-0 z-40">
          <div className="container flex h-16 items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold gradient-text-primary">Review Mode</h1>
              <p className="text-sm text-muted-foreground">Practice words due for review</p>
            </div>
          </div>
        </header>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-teal-50 to-pink-50">
        <header className="bg-white/80 backdrop-blur-sm border-b shadow-playful sticky top-0 z-40">
          <div className="container flex h-16 items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold gradient-text-primary">Review Complete!</h1>
            </div>
          </div>
        </header>
        ...
        <div className="container flex h-16 items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-orange-600">
              ...
              <span className="font-bold">{totalDue} due</span>
            </div>
          </div>
        </div>
      </header>
